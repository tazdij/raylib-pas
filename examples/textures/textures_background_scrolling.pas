...
begin
    ...
    background := LoadTexture('res/textures/cyberpunk_street_background.png');
    midground := LoadTexture('res/textures/cyberpunk_street_midground.png');
    foreground := LoadTexture('res/textures/cyberpunk_street_foreground.png');
    music := LoadMusicStream('res/music/axel.mod');
    music.looping:=true;
